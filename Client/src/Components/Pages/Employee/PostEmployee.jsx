  ...
  return (
    <div>
     <div className="container -translate-y-[300px]">
        <h1 className='text-center text-4xl -translate-y-24 ml-44 font-bold uppercase text-gray-300 underline'>Register Employee</h1>
      <form className='ml-[500px] -translate-y-[120px] shadow-md shadow-gray-200 p-4 w-[500px]'>
